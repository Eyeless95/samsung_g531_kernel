...
#include <linux/input/zt7554_platform_data.h>
...
static const unsigned long touch_cpufreq_lock = 500000;
#endif
...
#define ZT7554_BTN_WIDTH						0x016d
...
#endif
//long ts_misc_fops_ioctl(struct file *filp, unsigned int cmd, unsigned long arg);
//int ts_misc_fops_open(struct inode *inode, struct file *filp);
//int ts_misc_fops_close(struct inode *inode, struct file *filp);
